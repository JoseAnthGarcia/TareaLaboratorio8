...
@WebServlet(name = "Admin2Servlet",urlPatterns = {"/Admin2Servlet"} )
public class Admin2Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (accion){
            case "listar":
                requestDispatcher= request.getRequestDispatcher("listarBodegasAdmin.jsp");
                requestDispatcher.forward(request,response);
                break;
            case "registrar":
                ArrayList<DistritoBean> listaDistritos = bodegaDao.obtenerDistritos();
                request.setAttribute("listaDistritos", listaDistritos);
                requestDispatcher= request.getRequestDispatcher("registrarBodega.jsp");
                requestDispatcher.forward(request,response);
                break;
        }
